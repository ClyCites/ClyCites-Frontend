...
import { getPathValue } from "@/app/app/expert/_lib/form-utils";
...
export function ExpertEntityDetailPage({ entityKey, recordId }: { entityKey: ExpertEntityKey; recordId: string }) {
