...
import { getPathValue } from "@/app/app/marketplace/_lib/form-utils";
...
export function MarketplaceEntityDetailPage({ entityKey, recordId }: { entityKey: MarketplaceEntityKey; recordId: string }) {
