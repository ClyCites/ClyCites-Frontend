...
import { getPathValue } from "@/app/app/admin/_lib/form-utils";
...
export function AdminEntityDetailPage({ entityKey, recordId }: { entityKey: AdminEntityKey; recordId: string }) {
