...
import { getPathValue } from "@/app/app/analytics/_lib/form-utils";
...
export function AnalyticsEntityDetailPage({ entityKey, recordId }: { entityKey: AnalyticsEntityKey; recordId: string }) {
