...
interface MarketplaceEntityPageProps {
  entityKey: EntityKey;
...
export function MarketplaceEntityPage({ entityKey, features }: MarketplaceEntityPageProps) {
  const workspaceId: WorkspaceId = "marketplace";
