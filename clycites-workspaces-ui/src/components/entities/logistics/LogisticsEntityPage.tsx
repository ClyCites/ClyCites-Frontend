...
interface LogisticsEntityPageProps {
  entityKey: EntityKey;
...
export function LogisticsEntityPage({ entityKey, features }: LogisticsEntityPageProps) {
  const workspaceId: WorkspaceId = "logistics";
