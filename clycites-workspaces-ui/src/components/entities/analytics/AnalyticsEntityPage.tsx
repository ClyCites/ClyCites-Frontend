...
interface AnalyticsEntityPageProps {
  entityKey: EntityKey;
...
export function AnalyticsEntityPage({ entityKey, features }: AnalyticsEntityPageProps) {
  const workspaceId: WorkspaceId = "analytics";
