...
interface AggregationEntityPageProps {
  entityKey: EntityKey;
...
export function AggregationEntityPage({ entityKey, features }: AggregationEntityPageProps) {
  const workspaceId: WorkspaceId = "aggregation";
