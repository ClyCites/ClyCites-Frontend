...
import { getPathValue } from "@/app/app/prices/_lib/form-utils";
...
export function PricesEntityDetailPage({ entityKey, recordId }: { entityKey: PricesEntityKey; recordId: string }) {
