...
import { getPathValue } from "@/app/app/logistics/_lib/form-utils";
...
export function LogisticsEntityDetailPage({ entityKey, recordId }: { entityKey: LogisticsEntityKey; recordId: string }) {
