...
import { getPathValue } from "@/app/app/finance/_lib/form-utils";
...
export function FinanceEntityDetailPage({ entityKey, recordId }: { entityKey: FinanceEntityKey; recordId: string }) {
