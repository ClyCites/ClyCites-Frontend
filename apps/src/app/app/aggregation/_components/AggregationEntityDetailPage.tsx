...
import { getPathValue } from "@/app/app/aggregation/_lib/form-utils";
...
export function AggregationEntityDetailPage({ entityKey, recordId }: { entityKey: AggregationEntityKey; recordId: string }) {
