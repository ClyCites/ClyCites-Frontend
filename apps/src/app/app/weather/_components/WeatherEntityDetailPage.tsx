...
import { getPathValue } from "@/app/app/weather/_lib/form-utils";
...
export function WeatherEntityDetailPage({ entityKey, recordId }: { entityKey: WeatherEntityKey; recordId: string }) {
