      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="panel-surface grid grid-cols-1 lg:grid-cols-2 gap-12 items-center rounded-3xl p-8 sm:p-12"
          >
            <div>
              <div className="flex items-center gap-3 mb-5">
                <span className="rounded-full bg-primary/14 px-3 py-1 text-xs font-semibold text-primary">
                  {current.badge}
                </span>
              </div>
            ...
            <div className="relative">
              <div className="mx-auto flex aspect-square w-full max-w-sm items-center justify-center rounded-3xl border border-primary/18 bg-primary/10">
                <Icon strokeWidth={1} className="h-40 w-40 text-primary/25" />
